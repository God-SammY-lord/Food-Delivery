...
import "../Cuisines/cuisines_style.css";
import ButterChicken from "../Cuisines/Indian/Butter Chicken.jpg";
import PalakPaneer from "../Cuisines/Indian/Palak Paneer.jpg";
import DaalMakhani from "../Cuisines/Indian/Daal Makhani.jpg";
import Chowmein from "../Cuisines/Chinese/Chowmein.jpg";
import RoastedDuck from "../Cuisines/Chinese/Roasted Duck.jpg";
import KungPaoChicken from "../Cuisines/Chinese/Kung Pao Chicken.jpg";
import SesameChicken from "../Cuisines/American/Sesame Chicken.jpg";
import SubmarineSandwich from "../Cuisines/American/Sumarine Sandwich.jpg";
import EggsBenedict from "../Cuisines/American/Eggs Benedict.jpg";
import GrilledBbqChickenPizza from "../Cuisines/Fast Food & BBQ/Grilled BBQ Chicken Pizza.jpg";
import GrilledHamburger from "../Cuisines/Fast Food & BBQ/Grilled Hamburger.jpg";
import GrilledCheeseBurrito from "../Cuisines/Fast Food & BBQ/Grilled Cheese Burrito.jpg";
import MargheritaPizza from "../Cuisines/Italian/Margherita Pizza.jpg";
import Lasagna from "../Cuisines/Italian/Lasagna.jpg";
import MushroomRissoto from "../Cuisines/Italian/Mushroom Risotto.jpg";
class SignedInCuisines extends Component {
  render() {
    return (
      <React.Fragment>
...
export default SignedInCuisines;
